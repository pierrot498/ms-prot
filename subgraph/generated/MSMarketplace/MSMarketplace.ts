...
export class ListingUpdated__Params {
  ...
  get updatedListing(): ListingUpdatedUpdatedListingStruct {
    return changetype<ListingUpdatedUpdatedListingStruct>(
      this._event.parameters[1].value.toTuple()
    );
  }
}

export class ListingUpdatedUpdatedListingStruct extends ethereum.Tuple {
  get listingId(): BigInt {
    return this[0].toBigInt();
  }
...
export class NewAcceptOffer extends ethereum.Event {
  get params(): NewAcceptOffer__Params {
    return new NewAcceptOffer__Params(this);
  }
}

export class NewAcceptOffer__Params {
  _event: NewAcceptOffer;

  constructor(event: NewAcceptOffer) {
    this._event = event;
  }
...
export class NewBidOffer extends ethereum.Event {
  get params(): NewBidOffer__Params {
    return new NewBidOffer__Params(this);
  }
}

export class NewBidOffer__Params {
  _event: NewBidOffer;

  constructor(event: NewBidOffer) {
    this._event = event;
  }
...
export class primaryMSCommunityFeeInfoUpdated extends ethereum.Event {
  get params(): primaryMSCommunityFeeInfoUpdated__Params {
    return new primaryMSCommunityFeeInfoUpdated__Params(this);
  }
}

export class primaryMSCommunityFeeInfoUpdated__Params {
  _event: primaryMSCommunityFeeInfoUpdated;

  constructor(event: primaryMSCommunityFeeInfoUpdated) {
    this._event = event;
  }
...
export class MSMarketplace__getMSCommunityFeeInfoResult {
  value0: Address;
  value1: i32;
...
export class MSMarketplace__getPlatformFeeInfoResult {
  value0: Address;
  value1: i32;
...
export class MSMarketplace__listingsResult {
  value0: BigInt;
  value1: Address;
  value2: Address;
  value3: BigInt;
...
export class MSMarketplace__offersResult {
  value0: Address;
  value1: BigInt;
  value2: i32;
  value3: Address;
...
export class MSMarketplace__winningBidResult {
  value0: BigInt;
  value1: Address;
  value2: BigInt;
  value3: Address;
...
export class MSMarketplace extends ethereum.SmartContract {
  static bind(address: Address): MSMarketplace {
    return new MSMarketplace("MSMarketplace", address);
  }
  ...
  getMSCommunityFeeInfo(): MSMarketplace__getMSCommunityFeeInfoResult {
    let result = super.call(
    ...
    return new MSMarketplace__getMSCommunityFeeInfoResult(
      result[0].toAddress(),
      result[1].toI32()
    );
  }
  ...
  try_getMSCommunityFeeInfo(): ethereum.CallResult<
    MSMarketplace__getMSCommunityFeeInfoResult
  > {
    let result = super.tryCall(
      "getMSCommunityFeeInfo",
      "getMSCommunityFeeInfo():(address,uint16)",
    ...
    return ethereum.CallResult.fromValue(
      new MSMarketplace__getMSCommunityFeeInfoResult(
        value[0].toAddress(),
        value[1].toI32()
      )
    );
  ...
  getPlatformFeeInfo(): MSMarketplace__getPlatformFeeInfoResult {
    let result = super.call(
      "getPlatformFeeInfo",
    ...
    return new MSMarketplace__getPlatformFeeInfoResult(
      result[0].toAddress(),
      result[1].toI32()
    );
  }
  ...
  try_getPlatformFeeInfo(): ethereum.CallResult<
    MSMarketplace__getPlatformFeeInfoResult
  > {
    let result = super.tryCall(
      "getPlatformFeeInfo",
      "getPlatformFeeInfo():(address,uint16)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new MSMarketplace__getPlatformFeeInfoResult(
        value[0].toAddress(),
        value[1].toI32()
      )
    );
  ...
  listings(param0: BigInt): MSMarketplace__listingsResult {
    let result = super.call(
      "listings",
    ...
    return new MSMarketplace__listingsResult(
      result[0].toBigInt(),
      result[1].toAddress(),
      result[2].toAddress(),
      result[3].toBigInt(),
  ...
  try_listings(
    param0: BigInt
  ): ethereum.CallResult<MSMarketplace__listingsResult> {
    let result = super.tryCall(
      "listings",
      "listings(uint256):(uint256,address,address,uint256,uint256,uint256,uint256,address,uint256,uint256,uint8,uint8)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new MSMarketplace__listingsResult(
        value[0].toBigInt(),
        value[1].toAddress(),
        value[2].toAddress(),
        value[3].toBigInt(),
  ...
  offers(
    ...
    param1: BigInt,
    param2: Address
  ): MSMarketplace__offersResult {
    let result = super.call(
      "offers",
      "offers(address,uint256,address):(address,uint256,uint8,address,uint256,address,uint256,uint256)",
      [
    ...
    return new MSMarketplace__offersResult(
      result[0].toAddress(),
      result[1].toBigInt(),
      result[2].toI32(),
      result[3].toAddress(),
  ...
  try_offers(
    ...
    param1: BigInt,
    param2: Address
  ): ethereum.CallResult<MSMarketplace__offersResult> {
    let result = super.tryCall(
      "offers",
      "offers(address,uint256,address):(address,uint256,uint8,address,uint256,address,uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new MSMarketplace__offersResult(
        value[0].toAddress(),
        value[1].toBigInt(),
        value[2].toI32(),
        value[3].toAddress(),
  ...
  winningBid(param0: BigInt): MSMarketplace__winningBidResult {
    let result = super.call(
      "winningBid",
    ...
    return new MSMarketplace__winningBidResult(
      result[0].toBigInt(),
      result[1].toAddress(),
      result[2].toBigInt(),
      result[3].toAddress(),
  ...
  try_winningBid(
    param0: BigInt
  ): ethereum.CallResult<MSMarketplace__winningBidResult> {
    let result = super.tryCall(
      "winningBid",
      "winningBid(uint256):(uint256,address,uint256,address,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new MSMarketplace__winningBidResult(
        value[0].toBigInt(),
        value[1].toAddress(),
        value[2].toBigInt(),
        value[3].toAddress(),
