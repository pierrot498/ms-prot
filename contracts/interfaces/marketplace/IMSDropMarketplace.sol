...
import "../../extension/interface/IPlatformFeeDrop.sol";

interface IMSDropMarketplace is IMSContract, IPlatformFeeDrop {
    ...
    /**
     *  @dev The details of dropAuction.
     *  @param auctionDrop          True for dropAuction
     * 
     *  @param platformAuctionDropFeeBps          
     */
    struct DropAuction {
        bool auctionDrop;
        uint256 platformAuctionDropFeeBps;
        address dropCreatorAddress;
    }
     ...
     *
     *  @param dropAuction           The details for dropAuction.
    **/
    ...
    **/
    ...
    event DropAuctionBuffersUpdated(uint256 timeBuffer, uint256 bidBufferBps);
